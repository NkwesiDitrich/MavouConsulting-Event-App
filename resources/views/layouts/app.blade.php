                ...
                <ul class="navbar-nav me-auto">
                    ...
                    @auth
                        ...
                        @if(auth()->user()->role === 'organizer' || auth()->user()->role === 'admin')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('organizer.dashboard') }}">Organizer</a>
                            </li>
                        @endif
                    @endauth
                </ul>
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                               <img src="{{ auth()->user()->profile_picture_url }}" alt="Profile" class="profile-avatar me-2">
                                {{ auth()->user()->name }}
                                <span class="badge bg-primary badge-role ms-2">{{ ucfirst(auth()->user()->role) }}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('profile.show') }}">
                                    <i class="fas fa-user me-2"></i>Profile
                                </a></li>
                                <li><a class="dropdown-item" href="{{ route('profile.events') }}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="mb-0">Connecting people through amazing events.</p>
                </div>
